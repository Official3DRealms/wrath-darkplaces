...
PRVM_DECLARE_clientfunction(CSQC_Steam_AchievementValue)
PRVM_DECLARE_clientfunction(CSQC_Steam_StatValue)
PRVM_DECLARE_clientfunction(CSQC_UpdateView)
PRVM_DECLARE_clientfunction(Controller_Type)
...
PRVM_DECLARE_function(CSQC_Steam_AchievementValue)
PRVM_DECLARE_function(CSQC_Steam_StatValue)
PRVM_DECLARE_function(CSQC_UpdateView)
PRVM_DECLARE_function(Controller_Type)
...
PRVM_DECLARE_function(SV_RunClientCommand)
...
PRVM_DECLARE_function(Menu_InputEvent)
PRVM_DECLARE_function(Menu_RendererRestarted)
PRVM_DECLARE_function(Menu_Steam_AchievementValue)
PRVM_DECLARE_function(Menu_Steam_StatValue)
...
PRVM_DECLARE_menufunction(Menu_InputEvent)
PRVM_DECLARE_menufunction(Menu_RendererRestarted)
PRVM_DECLARE_menufunction(Menu_Steam_AchievementValue)
PRVM_DECLARE_menufunction(Menu_Steam_StatValue)
PRVM_DECLARE_menufunction(Controller_Type)
...
PRVM_DECLARE_serverfunction(SV_RunClientCommand)
...
PRVM_DECLARE_serverglobalvector(getlight_ambient)
PRVM_DECLARE_serverglobalvector(getlight_diffuse)
PRVM_DECLARE_serverglobalvector(getlight_dir)
