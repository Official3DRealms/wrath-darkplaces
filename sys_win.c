...
/*
	This tells Windows to fuck off and disable any autoscaling on HiDPI displays,
	because for some reason just setting it in the manifest doesn't seem to do anything.
...
int WINAPI WinMain (HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	Sys_SetDPIAware(); // this has to be called before video init
